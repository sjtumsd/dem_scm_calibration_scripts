...
void runPlateDrop(ChSystemGpuMesh& gpu_sys, ChGpuSimulationParameters& params) {
    ...
    float plate_radius = 20.f;
    float plate_height = 40.f;
    float plate_mass = 0.001;
    gpu_sys.AddMesh(GetChronoDataFile("models/cylinder.obj"), ChVector<float>(0), ChMatrix33<float>(plate_radius),
        plate_mass/2);
    ...
    ChVector<> plate_initial_pos(0, 0, -39);
