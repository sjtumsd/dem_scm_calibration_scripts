...
for nsamples in range(5):
    ...
    for nfig in range(6):
        ...
        mpl.plot(posterior_para_new[:,0], color='green',    alpha=.7, linestyle='solid',   linewidth = 2, label='Chain 1')
        mpl.plot(posterior_para_new[:,1], color='blue',  alpha=.7, linestyle='dotted',  linewidth = 2, label='Chain 2')
        mpl.plot(posterior_para_new[:,2], color='orange', alpha=.7, linestyle='dashed',  linewidth = 2, label='Chain 3')
        mpl.plot(posterior_para_new[:,3], color='red',   alpha=.7, linestyle='dashdot', linewidth = 2, label='Chain 4')
        ...
        sns.kdeplot(posterior_para_new[:,0], color='green',    fill=False, alpha=1, ls='-', linewidth=2.0, bw_adjust=0.5)
        sns.kdeplot(posterior_para_new[:,1], color='blue',  fill=False, alpha=1, ls=':', linewidth=2.0, bw_adjust=0.5)
        sns.kdeplot(posterior_para_new[:,2], color='orange', fill=False, alpha=1, ls='--',linewidth=2.0, bw_adjust=0.5)
        sns.kdeplot(posterior_para_new[:,3], color='red',   fill=False, alpha=1, ls='-.',linewidth=2.0, bw_adjust=0.5)
        ...
        if names[nfig]=="phi":
            textBinwidth = 'Bin Width = %.2f' %binwidth
