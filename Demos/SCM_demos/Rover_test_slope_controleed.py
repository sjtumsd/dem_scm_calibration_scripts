...
mysystem.Set_G_acc(chrono.ChVectorD(0,-9.8,0.0))
...
chassis_centre = chrono.ChVectorD(0, wheel_rad+0.01, -5)
wheel_mass = 17
chassis_mass=17
ang_vel=2       
...
wheel_1.SetPos(chassis_centre+chrono.ChVectorD(-0.923,0,-1.136))
...
wheel_2.SetPos(chassis_centre+chrono.ChVectorD(0.923,0,-1.136))
...
wheel_3.SetPos(chassis_centre+chrono.ChVectorD(-0.999,0,0))
...
wheel_4.SetPos(chassis_centre+chrono.ChVectorD(0.999,0,0))
...
wheel_5.SetPos(chassis_centre+chrono.ChVectorD(-0.923,0,1.136))
...
wheel_6.SetPos(chassis_centre+chrono.ChVectorD(0.923,0,1.136))
...
prismatic1.Initialize(chassis, axle1, chrono.ChCoordsysD(chassis_centre+chrono.ChVectorD(-0.923,0,-1.136), chrono.QUNIT))
mysystem.AddLink(prismatic1)

prismatic2 = chrono.ChLinkLockPrismatic()
prismatic2.Initialize(chassis, axle1, chrono.ChCoordsysD(chassis_centre+chrono.ChVectorD(-0.923,0,-1.136), chrono.Q_from_AngX(-math.pi/2)))
mysystem.AddLink(prismatic2)

prismatic3 = chrono.ChLinkLockPrismatic()
prismatic3.Initialize(chassis, axle2, chrono.ChCoordsysD(chassis_centre+chrono.ChVectorD(0.923,0,-1.136), chrono.QUNIT))
mysystem.AddLink(prismatic3)

prismatic4 = chrono.ChLinkLockPrismatic()
prismatic4.Initialize(chassis, axle2, chrono.ChCoordsysD(chassis_centre+chrono.ChVectorD(0.923,0,-1.136), chrono.Q_from_AngX(-math.pi/2)))
mysystem.AddLink(prismatic4)

prismatic5 = chrono.ChLinkLockPrismatic()
prismatic5.Initialize(chassis, axle3, chrono.ChCoordsysD(chassis_centre+chrono.ChVectorD(-0.999,0,0), chrono.QUNIT))
mysystem.AddLink(prismatic5)

prismatic6 = chrono.ChLinkLockPrismatic()
prismatic6.Initialize(chassis, axle3, chrono.ChCoordsysD(chassis_centre+chrono.ChVectorD(-0.999,0,0), chrono.Q_from_AngX(-math.pi/2)))
mysystem.AddLink(prismatic6)

prismatic7 = chrono.ChLinkLockPrismatic()
prismatic7.Initialize(chassis, axle4, chrono.ChCoordsysD(chassis_centre+chrono.ChVectorD(0.999,0,0), chrono.QUNIT))
mysystem.AddLink(prismatic7)

prismatic8 = chrono.ChLinkLockPrismatic()
prismatic8.Initialize(chassis, axle4, chrono.ChCoordsysD(chassis_centre+chrono.ChVectorD(0.999,0,0), chrono.Q_from_AngX(-math.pi/2)))
mysystem.AddLink(prismatic8)

prismatic9 = chrono.ChLinkLockPrismatic()
prismatic9.Initialize(chassis, axle5, chrono.ChCoordsysD(chassis_centre+chrono.ChVectorD(-0.923,0,1.136), chrono.QUNIT))
mysystem.AddLink(prismatic9)

prismatic10 = chrono.ChLinkLockPrismatic()
prismatic10.Initialize(chassis, axle5, chrono.ChCoordsysD(chassis_centre+chrono.ChVectorD(-0.923,0,1.136), chrono.Q_from_AngX(-math.pi/2)))
mysystem.AddLink(prismatic10)

prismatic11 = chrono.ChLinkLockPrismatic()
prismatic11.Initialize(chassis, axle6, chrono.ChCoordsysD(chassis_centre+chrono.ChVectorD(0.923,0,1.136), chrono.QUNIT))
mysystem.AddLink(prismatic11)

prismatic12 = chrono.ChLinkLockPrismatic()
prismatic12.Initialize(chassis, axle6, chrono.ChCoordsysD(chassis_centre+chrono.ChVectorD(0.923,0,1.136), chrono.Q_from_AngX(-math.pi/2)))
...
terrain.Initialize(3.0, 20.0, 0.02)
